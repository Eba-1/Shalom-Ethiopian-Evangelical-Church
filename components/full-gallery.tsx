...
const galleryPhotos: GalleryPhoto[] = [
  ...
  { src: "/gallery/full/praise-leader.webp", alt: "A worship leader singing during Sunday service", title: "Leading in Praise", category: "Worship" },
  { src: "/gallery/full/worship-in-stillness.webp", alt: "A man worshiping quietly with his hand over his heart", title: "Worship in Stillness", category: "Worship" },
  { src: "/gallery/full/heart-of-worship-community.webp", alt: "A woman worshiping with the congregation", title: "A Heart of Worship", category: "Worship" },
  { src: "/gallery/full/choir-in-unity.webp", alt: "The choir singing together beneath the cross", title: "Choir in Unity", category: "Worship" },
  { src: "/gallery/full/anniversary-celebration.webp", alt: "Church members celebrating together around a cake", title: "A Joyful Celebration", category: "Community" },
  { src: "/gallery/full/keys-of-praise.webp", alt: "A musician playing keyboard during worship", title: "Keys of Praise", category: "Worship" },
  { src: "/gallery/full/shalom-family-portrait.webp", alt: "The Shalom church family gathered for a group portrait", title: "The Shalom Family", category: "Community", featured: true },
  { src: "/gallery/full/open-word.webp", alt: "Hands holding an open Bible during service", title: "An Open Word", category: "Worship" },
  { src: "/gallery/full/joyful-congregation.webp", alt: "The congregation gathered in joyful worship", title: "Joy in His Presence", category: "Community" },
  { src: "/gallery/full/lifted-in-praise.webp", alt: "A woman lifting her hand during praise", title: "Lifted in Praise", category: "Worship" },
  { src: "/gallery/full/worship-musicians.webp", alt: "Church musicians serving together during worship", title: "Music in Ministry", category: "Worship" },
  { src: "/gallery/full/leading-song.webp", alt: "A singer leading the church in worship", title: "A Song of Faith", category: "Worship" },
  { src: "/gallery/full/heritage-and-praise.webp", alt: "Church members worshiping in traditional Ethiopian clothing", title: "Heritage & Praise", category: "Community", featured: true },
  { src: "/gallery/full/community-prayer.webp", alt: "Church members praying together in the sanctuary", title: "Prayer in Community", category: "Community" },
  { src: "/gallery/full/prayer-and-grace.webp", alt: "A woman praying during a church gathering", title: "Prayer & Grace", category: "Worship" },
  { src: "/gallery/full/steadfast-faith.webp", alt: "An elder lifting his hands in worship", title: "Steadfast Faith", category: "Worship" },
  { src: "/gallery/full/warm-welcome.webp", alt: "A smiling member of the Shalom church community", title: "A Warm Welcome", category: "Community" },
  { src: "/gallery/full/fellowship-smile.webp", alt: "A church member smiling during fellowship", title: "Fellowship & Joy", category: "Fellowship" },
  { src: "/gallery/full/joyful-fellowship.webp", alt: "A church member sharing a joyful moment", title: "Joyful Fellowship", category: "Fellowship" },
  { src: "/gallery/full/young-servers.webp", alt: "A young church member serving during fellowship", title: "Ready to Serve", category: "Children" },
  { src: "/gallery/full/youth-worship.webp", alt: "A young worship leader singing during service", title: "The Next Voice", category: "Children" },
  { src: "/gallery/full/congregation-celebration.webp", alt: "The congregation celebrating together in worship", title: "Together in Celebration", category: "Community" },
  { src: "/gallery/full/pastor-teaching.webp", alt: "Pastor Melkamu teaching from the Bible", title: "Teaching the Word", category: "Worship" },
  { src: "/gallery/full/worship-leader.webp", alt: "A worship leader singing with the choir", title: "Leading with Joy", category: "Worship" },
  { src: "/gallery/full/celebration-family.webp", alt: "Church families gathered for a special celebration", title: "Celebrating Together", category: "Fellowship" },
  { src: "/gallery/full/fellowship-banquet.webp", alt: "The church community sharing a banquet together", title: "Around the Table", category: "Fellowship", featured: true },
  { src: "/gallery/full/brothers-preparing.webp", alt: "Men preparing food together for church fellowship", title: "Preparing Together", category: "Fellowship" },
  { src: "/gallery/full/table-community.webp", alt: "Church members sharing a meal in community", title: "Table Community", category: "Fellowship" },
  { src: "/gallery/full/outreach-witness.webp", alt: "Young church members sharing messages of Jesus outside the church", title: "Faith in the Community", category: "Outreach" },
  { src: "/gallery/full/youth-retreat.webp", alt: "Young people gathered together during a church retreat", title: "Youth Together", category: "Children" },
  { src: "/gallery/full/youth-table.webp", alt: "Young people sharing a meal and conversation", title: "Growing in Friendship", category: "Children" },
];
